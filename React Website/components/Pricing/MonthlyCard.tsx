...
import { PricingCard, CardInner, CardTop, CardHeader } from './pricingStyles'
...
const MonthlyCard = ({ setPromotionDialog }: Props) => {
              ...
              <input
                ...
                value={
                  process.env.NEXT_PUBLIC_ENV === 'production'
                    ...
                    : 'Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC80MjA3OTQyNzM5NTgwMw=='
                }
              />
