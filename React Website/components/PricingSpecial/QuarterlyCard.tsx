...
import { PricingCard, CardInner, CardTop } from './PricingSpecialStyles'
import AddToCartForm from 'Components/AddToCartForm'
import Button from 'Components/primitives/form/Button'

interface Props {
  setPromotionDialog: (item: Props) => void
}

const QuarterlySpecialCard = ({ setPromotionDialog }: Props) => {
...
export default QuarterlySpecialCard
